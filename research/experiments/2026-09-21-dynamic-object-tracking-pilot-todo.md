...
- Date: 2026-09-21
- Status: bounded Phase D0 and Phase D1 pilots complete by 2026-09-23; the full Phase D2 comparison remains open
...
- [x] Add CoTracker foreground/background residual evidence; one moving-person run and one parked-bicycle control are recorded in `2026-09-23-cotracker-motion-residual-pilot.md`, with overlapping distributions and no universal threshold claim.
- [x] Measure ID switches, fragmentation and occlusion failures on a fixed assessable subset; two tracks/70 frames yielded zero observed switches and one recoverable bicycle fragmentation episode, with three tiny or absent candidates explicitly excluded rather than scored.
